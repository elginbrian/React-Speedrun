    ...
    <div className="w-full py-[10rem] px-4 bg-white">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <button className="bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto py-2 text-black">Start Free Trial!</button>
        </div>
        ...
        <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
          ...
          <button className="bg-black text-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-2">Subscribe</button>
        </div>
